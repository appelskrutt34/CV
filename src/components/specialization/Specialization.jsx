      ...
      <div className="row justify-content-center margin-top-md">
        <div className={[style.card, style.cardPink, "col-auto "].join(" ")}>
          ...
          <div className={style.cardText}>
            ...
            <p>ASP.NET</p>
            <ProgressBar percentage="70%" color="green" />
            <p>Unity</p>
            <ProgressBar percentage="50%" color="green" />
            <p>Azure DevOps</p>
            <ProgressBar percentage="65%" color="green" />
            <p>SQL Server</p>
            <ProgressBar percentage="50%" color="green" />
          </div>
        </div>
        <div className={[style.card, style.cardBlue, "col-auto"].join(" ")}>
          ...
          <div className={style.cardText}>
            <p>Javascript</p>
            <ProgressBar percentage="80%" color="pink" />
            <p>HTML</p>
            <ProgressBar percentage="95%" color="pink" />
            <p>CSS</p>
            <ProgressBar percentage="80%" color="pink" />
            <p>React</p>
            <ProgressBar percentage="60%" color="pink" />
            <p>VueJs</p>
            <ProgressBar percentage="60%" color="pink" />
            <p>Svelte</p>
            <ProgressBar percentage="50%" color="pink" />
          </div>
        </div>
