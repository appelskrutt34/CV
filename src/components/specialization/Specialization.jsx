      ...
      <div className="row justify-content-center margin-top-md">
        <div className={[style.card, style.cardPink, "col-auto "].join(" ")}>
          ...
          <div className={style.cardText}>
            <p className="font-m">
              I have over 7+ years experience with C# starting from hobby
              projects in <span className="bold">Unity</span> and then working
              with different <span className="bold">.NET</span> enviroments like{" "}
              <span className="bold">WPF</span> and{" "}
              <span className="bold">Xamarin</span>.{" "}
              <span className="block"></span> Today I'm an{" "}
              <span className="bold">ASP.NET</span> developer.
            </p>
          </div>
        </div>
        <div className={[style.card, style.cardBlue, "col-auto"].join(" ")}>
          ...
          <div className={style.cardText}>
            <p className="font-m">
              I work with Javascript daily in{" "}
              <span className="bold">ASP.NET</span> and{" "}
              <span className="bold">React</span>. I also have a lot of
              experience with javascript from previous jobs and hobby projects
              in <span className="bold">Vue.Js</span>. Apart from Javascript I
              also know <span className="bold">HTML</span> and{" "}
        ...
        <div className={[style.card, style.cardGreen, "col-auto"].join(" ")}>
          ...
          <div className={style.cardText}>
            <p className="font-m">
              On my freetime I like working with ethereum blockchain. I know how
              to build <span className="bold">ERC20</span> and{" "}
              <span className="bold">ERC721</span> tokens with{" "}
              <span className="bold">Solidity</span> and I have certificates in{" "}
              <span className="bold">smart contract</span> and{" "}
              <span className="bold">dapp programming</span>.
            </p>
          </div>
        </div>
      </div>
